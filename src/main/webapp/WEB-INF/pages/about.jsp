...
<head>
    ...
    <meta name="keywords"
          content="urbanic, responsive, bootstrap, fluid layout, orange, white, free website template, templatemo"/>
    <meta name="description"
          content="Urbanic is free responsive template using Bootstrap which is compatible with mobile devices. This layout is provided by templatemo for free of charge."/>
    <meta charset="UTF-8">
    ...
    <!-- Bootstrap core CSS -->
    <link href="/resources/res2/css/bootstrap.css" rel='stylesheet' type='text/css'>

    <!-- Custom styles for this template -->
    <link href="/resources/res2/js/colorbox/colorbox.css" rel='stylesheet' type='text/css'>
    <link href="/resources/res2/css/templatemo_style.css" rel='stylesheet' type='text/css'>
        ...
        <div class="navbar navbar-default" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="http://www.templatemo.com/preview/templatemo_395_urbanic"
                       rel="nofollow"><img src="images/templatemo_logo.png" alt="logo"/></a>
                </div>
...
<div>
    ...
    <div id="templatemo-carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="container">
                    <div class="carousel-caption">
                        <div class="col-sm-6 col-md-6">
                            ...
                            <p>Suspendisse pellentesque, odio vel ultricies interdum, mauris nulla ullamcorper magna,
                                non aliquet odio velit aliquam augue.</p>
                        </div>
                        <div class="col-sm-6 col-md-6">
                            <h1>ENERGY</h1>

                            <p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos
                                himenaeos. Nullam mattis fringilla urna.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="container">
                    <div class="carousel-caption">
                        ...
                        <p>This template is free to download and use for any website. This is a mobile-ready layout
        ...
        <a class="left carousel-control" href="#templatemo-carousel" data-slide="prev"><span
                class="glyphicon glyphicon-chevron-left"></span></a>
        <a class="right carousel-control" href="#templatemo-carousel" data-slide="next"><span
...
<div class="templatemo-welcome" id="templatemo-welcome">
    <div class="container">
        <div class="templatemo-slogan text-center">
            ...
            <p class="txt_slogan"><i>Lorem ipsum dolor sit amet, consect adipiscing elit. Etiam metus libero mauriec
                ignissim fermentum.</i></p>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="templatemo-service-item">
                    ...
                    <p>Nam porta adipiscing tortor, eget rutrum turpis bibendum ut. Donec eu lacus in diam euismod
                        imperdiet eu ut turpis. Morbi felis orci, tincidunt pretium laoreet id, euismod et lacus.
                        Praesent aliquet magna vitae mi elementum pharetra.</p>
            ...
            <div class="col-md-4">
                <div class="templatemo-service-item">
                    ...
                    <p>Urbanic theme is free <a href="http://www.templatemo.com/page/1" target="_parent">responsive
                        HTML5 template</a> by templatemo. Credits go to <a rel="nofollow"
                                                                           href="http://getbootstrap.com">Bootstrap</a>
                        for responsive layout and <a rel="nofollow" href="http://unsplash.com">Unsplash</a> for images
                        used in this <a href="http://www.tooplate.com">free template</a>. Curabitur non eros ut dolor
                        tincidunt interdum sit amet vitae quam.</p>
            ...
            <div class="col-md-4">
                <div class="templatemo-service-item">
                    ...
                    <p>Morbi imperdiet ipsum sit amet dui pharetra, vulputate porta neque tristique. Quisque id turpis
                        tristique, venenatis erat sit amet, venenatis turpis. Ut tellus ipsum, posuere bibendum
                        consectetur vel, egestas sit amet erat. Morbi rhoncus leo fermentum viverra.</p>
            ...
            <li class="col-lg-3 col-md-3 col-sm-6 ">
                <div class="text-center">
                    <div class="member-thumb">
                        ...
                        <div class="thumb-overlay">
                            <a href="https://www.facebook.com/templatemo" rel="nofollow"><span
                                    class="social-icon-fb"></span></a>
                            <a href="#"><span class="social-icon-twitter"></span></a>
                            <a href="#"><span class="social-icon-linkedin"></span></a>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="templatemo-gallery-category" style="font-size:16px; margin-top:80px;">
                <div class="text-center">
                    <a class="active" href=".gallery">All</a> / <a href=".gallery-design">Web Design </a>/ <a
                        href=".gallery-graphic">Graphic</a> / <a href=".gallery-inspiration">Inspiration</a> / <a
                        href=".gallery-creative">Creative</a>
                </div>
            </div>
        </div>
        <!-- /.row -->
            ...
            <div class="col-sm-5 col-md-6 blog_post">
                <ul class="list-inline">
                    ...
                    <li class="col-md-8">
                        ...
                        <div class="clearfix"></div>
                        <p class="blog_text">
                            Aliquam quis rutrum risus, ut condimentum ipsum. Nullam aliquet libero augue, eget auctor
                            felis vulputate id. Proin a enim eu libero ornare malesuada. Sed iaculis fringilla lacinia.
                            Sed laoreet lectus vitae [...]
                        </p>
                    </li>
                </ul>
            </div>
                ...
                <ul class="list-inline">
                    ...
                    <li class="col-md-8">
                        <div class="pull-left">
                            ...
                            <span>Posted by : <a class="link_orange" href="#"><span
                                    class="txt_orange">Mary</span></a></span>
                        </div>
                        <div class="pull-right">
                        ...
                        <div class="clearfix"></div>
                        <p class="blog_text">
                            Morbi imperdiet ipsum sit amet dui pharetra, vulputate porta neque tristique. Quisque id
                            turpis tristique, venenatis erat sit amet, venenatis turpis. Ut tellus ipsum, posuere
                            bibendum [...]
                        </p>
                    </li>
                </ul>
            ...
            <div class="col-sm-5 col-md-6 blog_post">
                <ul class="list-inline">
                    ...
                    <li class="col-md-8">
                        ...
                        <div class="clearfix"></div>
                        <p class="blog_text">
                            Fusce molestie tellus risus, id commodo turpis convallis id. Morbi mattis sapien sapien,
                            vitae lacinia ante interdum sit amet. Praesent eget varius diam, ac tempor est. Mauris at
                            scelerisque magna [...]
                        </p>
                    </li>
                </ul>
            ...
            <div class="col-sm-5 col-md-6 blog_post">
                <ul class="list-inline">
                    ...
                    <li class="col-md-8">
                        ...
                        <div class="clearfix"></div>
                        <p class="blog_text">
                            In venenatis sodales purus a cursus. Ut consectetur, libero ac elementum tristique, enim
                            ante aliquet mauris, scelerisque congue magna neque ac purus. Aliquam facilisis volutpat
                            odio [...]
                        </p>
                    </li>
                </ul>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="clearfix"></div>
                <i>You can find us on 123 Dagon Studio, Yankin Street, <span class="txt_orange">Digital Estate</span> in
                    Yangon.</i>
            </div>
            <div class="col-md-4 contact_right">
                ...
                <p><img src="images/globe.png" alt="icon 3"/><a class="link_orange" href="#"><span class="txt_orange">www.templatemo.com</span></a>
                </p>
    ...
    <div class="container">
        <div class="row">
            <div class="text-center">
                ...
                <div class="footer_bottom_content">Copyright © 2084 <a href="#">Your Company Name</a> - <a
                        href="http://www.templatemo.com/page/1">HTML5 Template</a> by <a class="link_orange"
                                                                                         href="http://www.templatemo.com/preview/templatemo_395_urbanic"
                                                                                         rel="nofollow"><span
                        class="txt_orange">Urbanic</span></a></div>

            </div>
        </div>
    </div>
</div>
<script src="<c:url value="/resources/res2/js/jquery.min.js" />"></script>
<script src="<c:url value="/resources/res2/js/bootstrap.min.js"/>" type="text/javascript"></script>
<script src="<c:url value="/resources/res2/js/stickUp.min.js"/>" type="text/javascript"></script>
<script src="<c:url value="/resources/res2/js/colorbox/jquery.colorbox-min.js"/>" type="text/javascript"></script>
<script src="<c:url value="/resources/res2/js/templatemo_script.js"/>" type="text/javascript"></script>
